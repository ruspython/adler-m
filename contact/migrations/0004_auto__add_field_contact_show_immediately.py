...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.show_immediately'
        db.add_column(u'contact_contact', 'show_immediately',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.show_immediately'
        db.delete_column(u'contact_contact', 'show_immediately')
    ...
    models = {
        u'contact.contact': {
            ...
            'show_immediately': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
