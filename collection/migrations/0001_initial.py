...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'collection_collectionitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collection.Collection'])),
            ('catalog_product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Item'], null=True, blank=True)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=100)),
        ))
        db.send_create_signal(u'collection', ['CollectionItem'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'collection_collectionitem')
