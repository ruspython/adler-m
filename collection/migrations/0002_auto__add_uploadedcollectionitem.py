...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UploadedCollectionItem'
        db.create_table(u'collection_uploadedcollectionitem', (
            ...
            ('manufacturer', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('scale', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal(u'collection', ['UploadedCollectionItem'])


    def backwards(self, orm):
        # Deleting model 'UploadedCollectionItem'
        db.delete_table(u'collection_uploadedcollectionitem')
    ...
    models = {
        ...
        u'collection.collection': {
            ...
            'code': ('django.db.models.fields.SlugField', [], {'default': '5593111032457600430L', 'unique': 'True', 'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
