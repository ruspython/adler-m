...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename field 'Collection.slug'
        db.rename_column(u'collection_collection', 'code', 'slug')

    def backwards(self, orm):
        # Adding field 'Collection.code'
        db.rename_column(u'collection_collection', 'slug', 'code')
    ...
    models = {
        ...
        u'collection.collection': {
            'Meta': {'ordering': "['slug']", 'object_name': 'Collection'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': '11973913734940705481L', 'unique': 'True', 'max_length': '50'}),
