...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'order_order', 'delivery_method',
                      self.gf('django.db.models.fields.CharField')(default='postal', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.delivery_method'
        db.delete_column(u'order_order', 'delivery_method')
