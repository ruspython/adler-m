...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.order_status'
        db.add_column(u'order_order', 'order_status',
    ...
    def backwards(self, orm):
        # Deleting field 'Order.order_status'
        db.delete_column(u'order_order', 'order_status')
    ...
    models = {
        ...
        u'order.order': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_status': ('django.db.models.fields.CharField', [], {'default': "'new'", 'max_length': '32'}),
