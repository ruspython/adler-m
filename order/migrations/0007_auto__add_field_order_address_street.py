...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.address_street'
        db.add_column(u'order_order', 'address_street',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.address_street'
        db.delete_column(u'order_order', 'address_street')
