...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'payment_and_delivery_deliverymethod', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('delivery_types', self.gf('django.db.models.fields.CharField')(default='post', max_length=32, blank=True)),
            ('price', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'payment_and_delivery', ['DeliveryMethod'])
        ...
        # Adding M2M table for field delivery_method on 'City'
        m2m_table_name = db.shorten_name(u'payment_and_delivery_city_delivery_method')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('city', models.ForeignKey(orm[u'payment_and_delivery.city'], null=False)),
            ('deliverymethod', models.ForeignKey(orm[u'payment_and_delivery.deliverymethod'], null=False))
        ))
        db.create_unique(m2m_table_name, ['city_id', 'deliverymethod_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'payment_and_delivery_deliverymethod')
        ...
        # Removing M2M table for field delivery_method on 'City'
        db.delete_table(db.shorten_name(u'payment_and_delivery_city_delivery_method'))
    ...
    models = {
        u'payment_and_delivery.city': {
            ...
            'delivery_method': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['payment_and_delivery.DeliveryMethod']", 'symmetrical': 'False'}),
        ...
        u'payment_and_delivery.deliverymethod': {
            'Meta': {'object_name': 'DeliveryMethod'},
            'delivery_types': ('django.db.models.fields.CharField', [], {'default': "'post'", 'max_length': '32', 'blank': 'True'}),
