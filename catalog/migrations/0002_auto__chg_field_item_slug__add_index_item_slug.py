...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'catalog_item', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50))
        # Adding index on 'Item', fields ['slug']
        db.create_index(u'catalog_item', ['slug'])


    def backwards(self, orm):
        # Removing index on 'Item', fields ['slug']
        db.delete_index(u'catalog_item', ['slug'])


        # Changing field 'Item.slug'
        db.alter_column(u'catalog_item', 'slug', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True))
