...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ItemType.image'
        db.alter_column(u'catalog_itemtype', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ItemType.image'
        db.alter_column(u'catalog_itemtype', 'image', self.gf('django_resized.forms.ResizedImageField')(max_length=100, max_height=200, max_width=200))
