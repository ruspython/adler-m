...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImportImage'
        db.create_table(u'catalog_importimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.ImportItem'])),
            ('dir', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('src', self.gf('django.db.models.fields.CharField')(max_length=1024)),
        ))
        db.send_create_signal(u'catalog', ['ImportImage'])


    def backwards(self, orm):
        # Deleting model 'ImportImage'
        db.delete_table(u'catalog_importimage')


    models = {
        u'catalog.importimage': {
            'Meta': {'object_name': 'ImportImage'},
            'dir': ('django.db.models.fields.CharField', [], {'max_length': '1024'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalog.ImportItem']"}),
