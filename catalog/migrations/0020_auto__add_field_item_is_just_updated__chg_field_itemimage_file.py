...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.is_just_updated'
        db.add_column(u'catalog_item', 'is_just_updated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'ItemImage.file'
        db.alter_column(u'catalog_itemimage', 'file', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'Item.is_just_updated'
        db.delete_column(u'catalog_item', 'is_just_updated')


        # Changing field 'ItemImage.file'
        db.alter_column(u'catalog_itemimage', 'file', self.gf('django_resized.forms.ResizedImageField')(max_length=100, max_height=1000, max_width=1020))
