...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalog_importitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uid', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('article', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('name_en', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('brand', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('brand_en', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('type_em', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('note', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('note_en', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('series', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('series_en', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('scale', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('manufacturer', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('manufacturer_en', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('color', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('color_en', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('material', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('tags', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('tags_en', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('weight', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('length', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('width', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('height', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('quantity', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('price', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('pricemin', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('publisher', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('publisher_en', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('author', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('author_en', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('statuspreorder', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('statusnew', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('statusnewavail', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('statusaction', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('statussale', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('statusway', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('statusbook', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('statusaccess', self.gf('django.db.models.fields.CharField')(max_length=512)),
        ))
        db.send_create_signal(u'catalog', ['ImportItem'])


    def backwards(self, orm):
        # Deleting model 'ImportItem'
        db.delete_table(u'catalog_importitem')
    ...
    models = {
        u'catalog.importitem': {
            ...
            'note_en': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            ...
            'type_em': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
