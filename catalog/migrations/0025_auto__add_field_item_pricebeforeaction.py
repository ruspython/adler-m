...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.pricebeforeaction'
        db.add_column(u'catalog_item', 'pricebeforeaction',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.pricebeforeaction'
        db.delete_column(u'catalog_item', 'pricebeforeaction')
    ...
    models = {
        ...
        u'catalog.item': {
            ...
            'pricebeforeaction': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
