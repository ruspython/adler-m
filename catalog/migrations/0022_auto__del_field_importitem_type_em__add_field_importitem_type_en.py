...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ImportItem.type_em'
        db.delete_column(u'catalog_importitem', 'type_em')

        # Adding field 'ImportItem.type_en'
        db.add_column(u'catalog_importitem', 'type_en',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ImportItem.type_em'
        raise RuntimeError("Cannot reverse this migration. 'ImportItem.type_em' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ImportItem.type_em'
        db.add_column(u'catalog_importitem', 'type_em',
                      self.gf('django.db.models.fields.CharField')(max_length=512),
                      keep_default=False)

        # Deleting field 'ImportItem.type_en'
        db.delete_column(u'catalog_importitem', 'type_en')
