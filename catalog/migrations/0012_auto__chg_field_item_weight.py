...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'catalog_item', 'weight', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Item.weight'
        db.alter_column(u'catalog_item', 'weight', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
