...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'seo_seoextension', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('public_extension', self.gf('django.db.models.fields.related.OneToOneField')(related_name='draft_extension', unique=True, null=True, to=orm['seo.SEOExtension'])),
        ...
        db.send_create_signal(u'seo', ['SEOExtension'])


    def backwards(self, orm):
        # Deleting model 'SEOExtension'
        db.delete_table(u'seo_seoextension')
